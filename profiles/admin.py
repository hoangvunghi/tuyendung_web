...
class UserInfoAdmin(BaseAdminClass):
    list_display = ('user', 'fullname', 'gender', 'balance', 'created_at', 'modified_at')
    list_filter = ('user', 'fullname', 'gender', 'balance', 'created_at', 'modified_at')
    search_fields = ('user', 'fullname', 'gender', 'balance', 'created_at', 'modified_at')
    list_display_links = ('user', 'fullname', 'gender', 'balance', 'created_at', 'modified_at')
